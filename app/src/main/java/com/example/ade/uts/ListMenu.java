...
public class ListMenu extends AppCompatActivity{
    ...
    private void setProducts() {
        ...
        Product product1 = new Product(1, "Sorabi", "Sorabi rasa mantap", 18000);
        Product product2 = new Product(2, "Pecel lele", "Pecel lele enak pisan asli", 15000);
        Product product3 = new Product(3, "Karedok", "Karedok mantaaappp", 15000);
        Product product4 = new Product(4, "Pisan ijo","Pisang ijo menggugah selera", 10000);
        Product product5 = new Product(5, "Rujak","Rujak sehah", 15000);
        Product product6 = new Product(6, "Sayur asem", "Sayur asemnya endoolll",  20000);
